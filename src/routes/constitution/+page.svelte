...
their Taxi Squad onto their roster's bench, or to accept the claim from the opposing manager. If the claim is accepted, then the manager who made the claim must send a compensatory draft pick equal to or greater than the round the claimed player was slected in +1 (If a player on Taxi Squad was drafted in start-up, then compensatory pick will be based player ADP in past rookie drafts).</p>
   ...
   <ul>
    ...
    <p>In the case a manager chooses to retire from the league, it is requested that they do so during the offseason at least 2 months before the season begins. In the case that one chooses to retire in the appropriate timeframe AND is able to find a replacement manager to takeover their team, they will get a full refund (including deposits on future years). In the case the retiring manager fails to find a replacement, they will only be guaranteed a refund of their deposit for the current year. Finally, any other retirement situation will result in NO REFUND WHATSOEVER. This includes midseason dropouts, abondonment, etc.</p>
