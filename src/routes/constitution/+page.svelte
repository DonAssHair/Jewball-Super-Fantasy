...
<div class="constitution">
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for the Monday after the week 14 games of the NFL season.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $200. Although you may trade FAAB budget, note that your total balance CAN exceed $200. Also note that budget does not rollover from year to year, and resets after the rookie draft. $0 bids are allowed. Bids will process Tuesdays and Saturdays at 8AM EST. After waivers clear on Saturdays all waiver wire players will be released and become free agents.</p>
...
their Taxi Squad onto their roster's bench, or to accept the claim from the opposing manager. If the claim is accepted, then the manager who made the claim must send a compensatory draft pick equal to or greater than the round the claimed player was slected in +1 (If a player on Taxi Squad was drafted in start-up, then compensatory pick will be based player ADP in past rookie drafts).</p>
    ...
    <p>The start-up draft will take place once the league has filled and every manager has paid their league fee. The startup draft order will be randomized in a reasonable fashion and published on sleeper. The draft wll be a 30-round snake-draft, 3rd-round reversal. Players are expected to be be active on the app to make your picks in a timely manner. The pick timer will be set at 8 hours per pick, with the timer being paused overnight (10PM-7AM). Those who fail to pick in the alloted time during the draft will be auto-picked.</p>
    ...
    <p>The draft order each year for rookie drafts will be determined by non-playoff teams' Max Points For (Max PF) from the previous season (in reverse order), then by the playoff teams' final standings. Max PF will only be counted during the regular season, up until Week 14.</p>
    <p>    <p/>
    <p>Draft Order:</p>
    <p>    1) Max PF</p>
    <p>    2) Max PF</p>
   ...
   <ul>
        ...
        <li>Be consistently active, returning texts and trade offers in a timely manner</li>
